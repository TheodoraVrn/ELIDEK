...
<?php
            ...
            <form class="form-horizontal" name="program-form" method="POST">
                 ...
                 Scientific Field: 
                 <select name="field">
                   <option disabled selected>-- Scientific Field --</option>
                       <?php
                     $sql = "SELECT * FROM scientific_field;";
                     $records = mysqli_query($conn, $sql);  
  
                    while($row = mysqli_fetch_array($records)) {
                    echo "<option value='". $row['field_id'] ."'>" .$row['name_sci_field'] ."</option>"; 
                    }	  
                   ?>  
                  </select>
                  <br><br>
        ...
        <div class="form-group col-sm-3 mb-3">
            <?php
                ...
                if(isset($_POST['submit_upd'])){
                    ...
                    $query = "INSERT INTO project_scientific_field (project_id, field_id) VALUES
                    ($project, $field);";
