...
<?php
$id = $_GET['id'];
                $query = "SELECT programm_name FROM programm WHERE programm_id = $id;";
                $res1 = mysqli_query($conn, $query);
                $row = mysqli_fetch_row($res1);

                echo '<div class="form-group col-sm-3 mb-3">';
                    echo '<label class = "form-label">Change information for programm: <br><b>' . $id . '</b></label>';
            ...
            <?php
                ...
                if(isset($_POST['submit_upd'])){
                    ...
                    $unit = $_POST['unit'];
                        ...
                        $query = "UPDATE programm
                                SET programm_name = '$name', unit = '$unit'
