...
<div class="container">
    ...
    <div class="row" id="row">
        <div class="col-md-12">
            <form class="form-horizontal" name="org-form" method="POST">
                <div class="form-group col-sm-3 mb-3">

        <br><br>
<?php
        $id = $_GET['id'];
                    $query = "SELECT * FROM organisation WHERE organisation_id = $id";
                    $res1 = mysqli_query($conn, $query);
                    $row = mysqli_fetch_row($res1);

                    echo '<div class="form-group col-sm-3 mb-3">';
                        echo '<label class = "form-label" style="width: 300px;">Are you sure you want to delete organisation <br><b>' . $row[0] . ' ' . $row[1] . '?</b></label>';
                        echo '<label class = "form-label" style="width: 300px;"> <br> <br>(Note: Please make sure you have updated/deleted the projects belonging to this organization and the researchers working for this organization, or else a fatal error will happen)</label>';
                    echo '</div>';
?>  
                     <br>
