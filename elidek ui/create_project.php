...
<?php
                ...
                echo "Please enter all the required info: " . "<br>";
                echo "<br>";
                echo "(Please note that you must only select researchers working on the projects organisation as supervisors)";
                echo '<hr></div>';
            ...
            <form class="form-horizontal" name="program-form" method="POST">
               ...
               <div class="form-group col-sm-3 mb-3">
                    <label class = "form-label">Required: Please Create an ID</label>
            ...
            <form class="form-horizontal" name="program-form" method="POST">
                ...
                <form method="post">
                 ...
                 <select name="executive">
                   <option disabled selected>-- Executive --</option>
                       <?php
        ...
        <div class="form-group col-sm-3 mb-3">
            <?php
                ...
                if(isset($_POST['submit_upd'])){
                    ...
                    $query = "INSERT INTO project (project_id, title, summary, funding_amount, 
                    start_date, end_date, executive_id, programm_id, organisation_id) VALUES
                    ($id, '$title', '$summary', '$funding_amount',
                    '$start_date', '$end_date', $executive, $programm, $org);";
                    ...
                    SET project_id=$id, title='$title', summary='$summary', funding_amount='$funding_amount',
                    start_date='$start_date', end_date='$end_date', executive_id=$executive, 
                    programm_id=$programm, organisation_id=$org,
                    supervisor_id = $query1, evaluator_id = $query2
                    WHERE project_id = $id;";
