...
<div class="container">
    ...
    <div class="row" id="row">
        <div class="col-md-12">
            <form class="form-horizontal" name="re-form" method="POST">
...
<?php
        $id = $_GET['id'];
                    ...
                    echo '<div class="form-group col-sm-3 mb-3">';
                        echo '<label class = "form-label" style="width: 300px;">Are you sure you want to delete researcher <br><b>' . $row[0] . ' ' . $row[1] . '?</b></label>';
                        echo '<label class = "form-label" style="width: 300px;"> <br><br> (Please note that all work done on a project will also be deleted)</label>';
                    echo '</div>';
?>  
                     <br>
