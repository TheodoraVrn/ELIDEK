...
<?php
$id = $_GET['id'];
                $query = "SELECT executive_name FROM executive WHERE executive_id = $id;";
                $res1 = mysqli_query($conn, $query);
                $row = mysqli_fetch_row($res1);

                echo '<div class="form-group col-sm-3 mb-3">';
                    echo '<label class = "form-label">Change information for executive: <br><b>' . $id . '</b></label>';
