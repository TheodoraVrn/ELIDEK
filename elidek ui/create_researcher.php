...
<div class="container">
    <div class="row" id="row">
        ...
        <br>
<?php
echo "Please add the required info: " . "<br>";
...
?>
            ...
            <form class="form-horizontal" name="researcher-form" method="POST">
                ...
                <div class="form-group col-sm-3 mb-3">
                 ...
                 <div class="form-group col-sm-3 mb-3">
                    <label class = "form-label">Organisation Starting Date</label>
        ...
        <div class="form-group col-sm-3 mb-3">
            <?php
                ...
                if(isset($_POST['submit_upd'])){
                    ...
                    $query = "INSERT INTO researcher (researcher_name, sex, 
                    birthdate, organisation_id, org_starting_date) values
                    ('$name', '$sex', '$birthdate', $query1, '$org_start_date');";
