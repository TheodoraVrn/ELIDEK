...
<?php
$id = $_GET['id'];
                $query = "SELECT name_sci_field FROM scientific_field WHERE field_id = $id;";
                $res1 = mysqli_query($conn, $query);
                $row = mysqli_fetch_row($res1);

                echo '<div class="form-group col-sm-3 mb-3">';
                    echo '<label class = "form-label">Change information for scientific field: <br><b>' . $id . '</b></label>';
