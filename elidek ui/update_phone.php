...
$id = $_GET['id'];
                ...
                echo '<div class="form-group col-sm-3 mb-3">';
                    echo '<label class = "form-label">Change information for phone number of Organisation no.: <br><b>' . $id . '</b></label>';
            ...
            <form class="form-horizontal" name="program-form" method="POST">
                ...
                <div class="form-group col-sm-3 mb-3">
                    ...
                    <input class = "form-control", name="phone", placeholder="Number">
                </div>
                ...
                if(isset($_POST['submit_upd'])){
                    ...
                    $phone = $_POST['phone'];
                        ...
                        if (mysqli_query($conn, $query)) {
                            echo "Record updated successfully! Please click 'Back'.";
                        }
                        else{
