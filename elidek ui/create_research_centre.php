                ...
                <form method="post">
                 ...
                 <select name="org">
                   <option disabled selected>-- Organisation --</option>
                       <?php
                     $sql = "SELECT * FROM organisation WHERE org_type = 'Research Centre';";
                  ...
                  <div class="form-group col-sm-3 mb-3">
                    ...
                    <input class = "form-control", name="budget1", placeholder="Budget">

                </div>
                <br>

                <div class="form-group col-sm-3 mb-3">
                    <label class = "form-label">Budget from Private Actions:</label>
                    <input class = "form-control", name="budget2", placeholder="Budget">
        ...
        <div class="form-group col-sm-3 mb-3">
            <?php
                ...
                if(isset($_POST['submit_upd'])){
                    ...
                    $query = "INSERT INTO company (organisation_id, org_type, assets) VALUES
                    ($org, 'Research Centre', $budget1, $budget2);";
