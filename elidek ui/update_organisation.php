...
<?php
$id = $_GET['id'];
                $query = "SELECT org_name FROM organisation WHERE organisation_id = $id;";
                $res1 = mysqli_query($conn, $query);
                $row = mysqli_fetch_row($res1);

                echo '<div class="form-group col-sm-3 mb-3">';
                    echo '<label class = "form-label">Change information for organization: <br><b>' . $id . '</b></label>';
            ...
            <form class="form-horizontal" name="program-form" method="POST">
                ...
                <div class="form-group col-sm-3 mb-3">
                    <label class = "form-label">New Abbreviation</label>
                ...
                <br>
                <div class="form-group col-sm-3 mb-3">
                    <label class = "form-label">New Postal Code</label>
                    <input class = "form-control", name="postal", placeholder="Postal Code">
                </div>
                <br>
                <div class="form-group col-sm-3 mb-3">
                    <label class = "form-label">New Street Name</label>
                    <input class = "form-control", name="street", placeholder="Street Name">
                </div>
                <br>
                <div class="form-group col-sm-3 mb-3">
                    <label class = "form-label">New Street Number</label>
                ...
                if(isset($_POST['submit_upd'])){
                    ...
                    $num = $_POST['num'];
                        ...
                        $query = "UPDATE organisation
                                SET org_name = '$name', abbreviation = '$abbreviation',
                                city = '$city', postal_code = '$postal', street = '$street', street_number = '$num'
